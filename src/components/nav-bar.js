...
const NavBar = (props) => {
  return (
    <div className={`nav-bar-container ${props.rootClassName} `}>
      <nav data-role="Header" className="nav-bar-navbar">
        <div className="nav-bar-left-side">
          <Link to="/" className="nav-bar-navlink">
            <Logo className="nav-bar-component"></Logo>
          </Link>
        </div>
        <div className="nav-bar-right-side">
          <div className="nav-bar-links-container">
            <Link to="/how-it-works" className="nav-bar-navlink1">
              {props.text}
            </Link>
            <Link to="/blog" className="nav-bar-navlink2">
              {props.text1}
            </Link>
            <Link to="/contact-us" className="nav-bar-navlink3">
              {props.text2}
            </Link>
          </div>
        </div>
        <div data-type="BurgerMenu" className="nav-bar-burger-menu">
          <svg viewBox="0 0 1024 1024" className="nav-bar-burger-menu">
            <path
        ...
        <div data-type="MobileMenu" className="nav-bar-mobile-menu">
          <div className="nav-bar-nav">
            <div className="nav-bar-top">
              <h1 className="">{props.Logo}</h1>
              <div data-type="CloseMobileMenu" className="nav-bar-close-menu">
            ...
            <div className="nav-bar-right-side1">
              <div className="nav-bar-links-container1">
                <span className="nav-bar-text">{props.text4}</span>
                <span className="nav-bar-text1">{props.text5}</span>
                <span className="nav-bar-text2">{props.text6}</span>
                <span className="">{props.text7}</span>
              </div>
              <SolidButton button="Explore places" className=""></SolidButton>
            </div>
          </div>
          <div className="nav-bar-follow-container">
            <span className="nav-bar-text4">{props.text3}</span>
      ...
      <Link to="/get-started" className="nav-bar-navlink4">
        <SolidButton2Light
          button="Get Started"
          rootClassName="solid-button2light-root-class-name"
          className="nav-bar-component2"
        ></SolidButton2Light>
      </Link>
    </div>
  )
